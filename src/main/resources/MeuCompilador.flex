...
"("        { return new Token(Token.E_PARENTESES, yytext()); }
")"        { return new Token(Token.R_PARENTESES, yytext()); }
"{"        { return new Token(Token.E_KEYS, yytext()); }
"}"        { return new Token(Token.R_KEYS, yytext()); }
"="        { return new Token(Token.IGUAL, yytext()); }
">="       { return new Token(Token.MINOR_EQUALS, yytext()); }
">"        { return new Token(Token.MINOR, yytext()); }
"<="       { return new Token(Token.MAJOR_EQUALS, yytext()); }
"<"        { return new Token(Token.MAJOR, yytext()); }
